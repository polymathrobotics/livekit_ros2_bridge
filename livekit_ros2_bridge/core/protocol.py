...
class LivekitRpcSubscriptionDataTransport(BaseModel):
    """Transport details for data-channel ROS topic delivery."""

    kind: Literal["data"] = "data"
    topic: str = Field(min_length=1)


class LivekitRpcSubscriptionVideoTransport(BaseModel):
    """Transport details for LiveKit video-track ROS topic delivery."""

    kind: Literal["video"] = "video"
    track_name: str = Field(min_length=1)


LivekitRpcSubscriptionTransport = Union[
...
class LivekitRpcSubscribeResponse(BaseModel):
    ...
    transport: LivekitRpcSubscriptionTransport
...
__all__ = [
    ...
    "LivekitRpcSubscriptionTransport",
    "LivekitRpcSubscriptionVideoTransport",
